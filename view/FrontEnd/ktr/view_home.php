...
<main>
    ...
    <div class="wrapper">
        ...
        <div class="image-container">
            <img src="public/img/1.jpg" alt="Image">
        </div>
    </div>
    ...
    <section class="wrap">
        <div class="content">
            <div class="left-column">
                <div class="image-container">
                    <img src="public/img/2.jpg" alt="Image" class="small-image">
                </div>
            </div>
    ...
    <div class="containe">
        ...
        <div class="cont">
            <div class="cardd">
                <img src="public/img/3.jpg" alt="Image 1">
            ...
            <div class="cardd">
                <img src="public/img/5.jpg" alt="Image 3">
                <div class="card-text">Utilitaire</div>

            </div>
            <div class="cardd">
                <img src="public/img/6.jpg" alt="Image 4">
    ...
    <div class="containe">
        ...
        <div class="cont">
            <div class="cardd">
                ...
                <div class="card-text" id="card-te">
                    <h3><span>Où se loger à Yaoundé ?</span></h3> <br>Pour les vacances, le travail, et de nombreuses
            ...
            <div class="cardd">
                ...
                <div class="card-text" id="card-te">
                    <h3><span>Conseils pour un road trip réussi</span></h3> <br>Pour la Saint-Valentin et bien d'autres occasions.
                </div>
